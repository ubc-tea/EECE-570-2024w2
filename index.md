...
| **2/3**   |  Andrew Feng, Xinye Zhan   <br> [peer-review]() <br>  Yannick Lecoeuche  <br> [peer-review]() | **Presentation** – <br> Medical Image Analysis | A multimodal generative AI copilot for human pathology <br> Nature 2024 [paper](https://www.nature.com/articles/s41586-024-07618-3) <br> NeuroClips: Towards High-fidelity and Smooth fMRI-to-Video Reconstruction <br> NeurIPS 2024 [paper](https://arxiv.org/pdf/2410.19452)|  Submit review <br> Submit peer-grading           |
...
|**3/19** | Milad Yazdani   <br> [peer-review]() <br>  Yizhou Li, Ethan McKeen  <br> [peer-review]() | **Presentation** – <br> Image Generative Models (Diffusion Models) | Consistency Diffusion Bridge Models <br> NeurIPS 2024 [paper](https://openreview.net/pdf?id=FFJFGx78OK) <br> FreeDoM: Training-Free Energy-Guided Conditional Diffusion Model <br> ICCV 2023 [paper](https://openaccess.thecvf.com/content/ICCV2023/papers/Yu_FreeDoM_Training-Free_Energy-Guided_Conditional_Diffusion_Model_ICCV_2023_paper.pdf)|  Submit review <br> Submit peer-grading        |                 |       
